...
export const useCartStore = create<State>()(
    ...
    // persist se encarga de guardar la informacion en el localstorage
    ...
    persist(
        (set, get) => ({
            ...
            addProductToCart: (product: CartProduct) => {
                ...
                // Veriricar si ya el producto existe en el carrito con la talla seleccionada
                ...
                // Si el producto existe por talla incrementar
