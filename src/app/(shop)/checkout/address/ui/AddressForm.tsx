...
export const AddressForm = ({ cities, userStoredAddress = {} }: Props) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
            ...
            <div className="flex flex-col mb-2 sm:col-span-2 sm:w-6/12">
                <span>Teléfono</span>
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-200"
            ...
            <div className='flex flex-col mb-2 sm:mt-1 sm:col-span-2'>
